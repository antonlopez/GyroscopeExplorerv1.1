...
/**
 * Created by Anton on 10/16/2016.
 */
...
public class Bluetooth extends Thread {
    ...
    private static Bluetooth __blue = null;

    public static Bluetooth getInstance(String n){
        return __blue == null ? new Bluetooth(n) : __blue;
    }

    public static Bluetooth getInstance(){
        return __blue == null ? new Bluetooth() : __blue;
    }


    private  Bluetooth(String Name){
        __blue = this;
        try {
